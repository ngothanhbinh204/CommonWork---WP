...
Các field phải đặt tên rõ ràng, phản ánh đúng nội dung và mục đích sử dụng.
Nhưng thẻ nội dung nếu nằm trong thẻ <p>, thì phải thay đổi bằng thẻ div để tránh việc render nội dùng từ acf bị lọt ra khỏi thẻ <p>, ví dụ:
Before: <p class="content">Đây là nội dung</p>
After: <div class="content">Đây là nội dung</div>
