...
function register_my_menu()
{
	$locations = array(
		...
		'header-mobile' => __('Menu mobile', 'canhcamtheme'),
		'footer-expertise' => __('Footer - Expertise', 'canhcamtheme'),
		'footer-portfolio' => __('Footer - Portfolio', 'canhcamtheme'),
		'footer-company' => __('Footer - Company', 'canhcamtheme'),
		'footer-legal' => __('Footer - Legal', 'canhcamtheme'),
	);
