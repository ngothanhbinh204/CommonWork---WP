...
<section class="about-team">
	<div class="about-team__inner __inner">
		<div class="about-team__head" data-aos="fade-up">
			<?php if ( $team_eyebrow ) : ?>
				<div class="highlight__eyebrow"><?php echo esc_html( $team_eyebrow ); ?></div>
			<?php endif; ?>
		...
		<div class="about-team__grid">
			...
			?>
				<div class="about-team-card hover-y-effect" data-aos="fade-up" data-aos-delay="<?php echo esc_attr( $delay ); ?>">
					<?php if ( $photo ) : ?>
						<div class="about-team-card__img">
							<?php echo get_image_attrachment( $photo['ID'], 'medium', '', '' ); ?>
						</div>
					<?php else : ?>
